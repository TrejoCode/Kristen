...
<div class="microsite flex">
    <div class="column">
        <!-- Banner -->
        <div class="banner justify-center align-center" style="background-image: url(../assets/img/header-pyme.jpg);">
            <div class="container">                
                <h2 class="color-white">LICENCIATURA EN ADMINISTRACIÓN Y GESTIÓN DE PYMES</h2>                
            </div>
        </div> <!-- End Banner -->
                        ...
                        <div class="column">
                            <div class="row-responsive">
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Ejercer las funciones de consultoría en las empresas.
                                        </p>
                                ...
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Proponer alternativas que permita el desarrollo óptimo de las organizaciones.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
                            ...
                            <div class="row-responsive">
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify">
                                            Aplicar tecnologías de Información en el comercio y los negocios.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
