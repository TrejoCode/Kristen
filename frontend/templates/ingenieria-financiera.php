...
<div class="microsite flex">
    <div class="column">
        <!-- Banner -->
        <div class="banner justify-center align-center" style="background-image: url(../assets/img/header-fina.jpg);">
            <div class="container">                
                <h2 class="color-white">INGENIERÍA FINANCIERA</h2>                
            </div>
        </div> <!-- End Banner -->
                        ...
                        <div class="column">
                            <div class="row-responsive">
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Diseñar portafolios de inversión Interpretar los factores que intervienen en los mercados bursátiles para el análisis de la expansión patrimonial.
                                        </p>
                                ...
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Medir los impactos de eventos micro-macro económicos en los mercados financieros.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
                            ...
                            <div class="row-responsive">
                                ...
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify">
                                            Evaluar la rentabilidad de las empresas públicas, privadas y sociales.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
