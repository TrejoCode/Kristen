...
<div class="microsite flex">
    <div class="column">
        <!-- Banner -->
        <div class="banner justify-center align-center" style="background-image: url(../assets/img/header-soft.jpg);">
            <div class="container">                
                <h2 class="color-white">INGENIERÍA EN SOFTWARE</h2>                
            </div>
        </div> <!-- End Banner -->
                        ...
                        <div class="column">
                            <div class="row-responsive">
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Identificar problemas y necesidades informáticas para definir soluciones de organizaciones o posibles mejoras.
                                        </p>
                                ...
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify"> 
                                            Utilización de tecnología de punta en las áreas de programación, diseño Web, graficación y animación por computadora y realidad virtual, entre otras.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
                            ...
                            <div class="row-responsive">
                                <div class="hability">
                                    ...
                                    <div class="hability-description column">
                                        <p class="text-justify">
                                            Diseñar, desarrollar y mantener sistemas computacionales.
                                        </p>
                                        <div class="white-space-24"></div>
                                    </div>
                                </div>
