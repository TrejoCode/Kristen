...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/BotaniQR/assets/css/admin.css" media="screen">
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/BotaniQR/favicon.ico">
                ...
                <div class="container">
                    <div class="left justify-start">
                        <div class="logo responsive-img">
                            <img src="<?php echo base_url();?>assets/BotaniQR/assets/img/logo.png" alt="">
                        </div>
                    </div>
                    <div class="right">
                        <div class="row justify-end align-center">
                            ...
                            <div class="end-session justify-end">
                                <a href="<?php echo base_url().'botaniqr/logout';?>"><i class="fas fa-sign-out-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
