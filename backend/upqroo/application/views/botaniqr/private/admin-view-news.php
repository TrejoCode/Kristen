            ...
            <?php if(!empty($noticias)){
                ...
                for($i=0; $i<count($noticias); $i++)
                {
                    ...
                    <div class="list-item">
                        ...
                        <div class="right">
                            <div class="column">
                                <a id="title" href="<?php echo base_url().'index.php/botaniqr/noticia/'.$noticias[$i]->id; ?>"><?php echo $noticias[$i]->nombre; ?></a>
                                <div class="row">
                                    <div class="edit align-center">
                                        <i class="far fa-edit"></i>
                                        <a href="<?php echo base_url().'index.php/botaniqr/administrador/editar/noticia/'.$noticias[$i]->id; ?>"> EDITAR</a>
                                    </div>
                                </div>
                            </div>
                        </div>
