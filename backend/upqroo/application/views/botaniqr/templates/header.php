        ...
        <div class="container">
            <div class="row">
                ...
                <nav class="flex align">
                    <ul class="flex">
                        <li><a href="<?php echo base_url().'index.php/'; ?>botaniqr">Inicio</a></li>
                        <li><a href="<?php echo base_url().'index.php/botaniqr/'; ?>plantas">Explorar</a></li>
                        <li><a href="<?php echo base_url().'index.php/botaniqr/'; ?>noticias">Noticias</a></li>
                    </ul>
                </nav>
            </div>
        </div>
