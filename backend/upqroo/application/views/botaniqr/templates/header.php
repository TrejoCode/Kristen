            ...
            <div class="container">
                <div class="logo">
                    <div class="responsive-img">
                        <a href="#"><img src="<?php echo base_url(); ?>BotaniQR/assets/img/logo.png" alt="BotaniQR Logo" title="BotaniQR Logo"></a>
                    </div>
                </div>
                <nav class="justify-end align-center">
                    <div class="nav-item auto">
                        <a href="<?php echo base_url().'index.php/'; ?>botaniqr"> INICIO</a>
                    </div>
                    <div class="nav-item auto">
                        <a href="<?php echo base_url().'index.php/botaniqr/'; ?>plantas">&nbsp EXPLORAR</a>
                    </div>
                    <div class="nav-item auto">
                        <a href="<?php echo base_url().'index.php/botaniqr/'; ?>noticias">&nbsp NOTICIAS</a>
                    </div>
                    <div class="nav-item auto">
                        <a href="<?php echo base_url().'index.php/botaniqr/'; ?>nosotros">&nbsp NOSOTROS</a>
                    </div>
                </nav>
            </div>
        </div>
