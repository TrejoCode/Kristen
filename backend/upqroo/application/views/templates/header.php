                    ...
                    <div class="row">
                        <div class="left">
                            <div class="row align-center">
                                <div class="phone">
                                    ...
                                    <a href="tel:9982831859">(998) 283 1859</a>
                                </div>

                                <div class="email">
                                    <i class="fas fa-envelope"></i>
                                    <a href="mailto:info@upqroo.edu.mx">info@upqroo.edu.mx</a>
                        ...
                        <div class="right">
                            <div class="row justify-end align-center">
                                <a class="facebook-icon" href="https://www.facebook.com/upqroo"><i class="fab fa-facebook-f"></i></a>
                                <a class="twitter-icon" href="https://twitter.com/upqroo"><i class="fab fa-twitter"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="right">
                            <nav class="row align-center justify-end">
                                <div class="nav-item wow fadeInLeft" data-wow-delay="0.5s">
                                    <a href="<?php echo base_url();?>nosotros">UNIVERSIDAD</a>
                                </div>
                                ...
                                <div class="nav-item wow fadeInLeft" data-wow-delay="0.7s"">
                                    <a href="<?php echo base_url();?>admision">SERVICIOS ESCOLARES</a>
                                </div>

                                <div class="nav-item wow fadeInLeft" data-wow-delay="0.8s"">
                                    <a href="<?php echo base_url();?>visitas">VINCULACIÓN</a>
                                </div>
                            </nav>
                        </div>
                    </div>
