            ...
            <?php if(!empty($eventos)){
                ...
                for($i=0; $i<count($eventos); $i++)
                {
                    ...
                    <div class="list-item">
                        ...
                        <div class="right">
                            <div class="column">
                                <a id="title" href="<?php echo base_url().'index.php/evento/ver/'.$eventos[$i]->idPublicaciones; ?>"><?php echo $eventos[$i]->titulo; ?></a>
                                <div class="row">
                                    <div class="edit align-center">
                                        <i class="far fa-edit"></i>
                                        <a href="<?php echo base_url().'index.php/administrador/editar/evento/'.$eventos[$i]->idPublicaciones; ?>"> EDITAR</a>
                                    </div>
                                </div>
                            </div>
                        </div>
